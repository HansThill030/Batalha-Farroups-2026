    ...
    <>
      <section className={styles.hero}>
        ...
        <div className={styles.content}>
          <Image src="/logo-icon.png" alt="Logo" width={90} height={90} className={styles.icon} />
          <Image src="/logo-text.png" alt="Batalha dos Farroups" width={320} height={120} className={styles.logoText} />
